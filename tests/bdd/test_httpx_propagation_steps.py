...
def _run_async_request(**kwargs: typ.Any) -> dict[str, str]:  # ruff: ignore[any-type] -- mirrors httpx kwargs.
...
def _run_sync_request(**kwargs: typ.Any) -> dict[str, str]:  # ruff: ignore[any-type] -- mirrors httpx kwargs.
